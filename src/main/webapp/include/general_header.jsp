        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="prueba.jsp" type="button" class="btn btn-outline-danger text-white bg-danger"><i class="fas fa-cart-plus">(<label style="color:orange">${contador}</label>)</i> Carrito</a>
                    </div>
                </div>
            </div>
        </nav>
